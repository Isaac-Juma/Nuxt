 ...
 * 2. Import Data 
 */
import LandingPage from '~/components/Tailwindcss_Ui_Design/Sitelayouts/LandingPage.vue';
...
<template>
  <h1 class="flex justify-center place-items-center">Solo Leveling Portal ⚔️</h1>
